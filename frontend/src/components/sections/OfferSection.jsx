        ...
        <div className="row">
          <div className="col-lg-6 col-md-12 col-sm-12 col-12">
            <div className="offer_area_box d-none-phone img_animation">
              <img
                src="https://andit.co/projects/html/and-tour/demo/assets/img/offer/offer1.png"
                alt="img"
              />
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 col-12">
            <div className="offer_area_box img_animation">
              <img
                src="https://andit.co/projects/html/and-tour/demo/assets/img/offer/offer2.png"
                alt="img"
              />
              <div className="offer_area_content">
                <h2>News letter</h2>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 col-12">
            <div className="offer_area_box img_animation">
              <img
                src="https://andit.co/projects/html/and-tour/demo/assets/img/offer/offer3.png"
                alt="img"
              />
              <div className="offer_area_content">
                <h2>Travel tips</h2>
